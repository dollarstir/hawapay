...
<head>
	...
	<!-- Bootstrap 4.0-->
	<link rel="stylesheet" href="app/view/allfiles/assets/vendor_components/bootstrap/dist/css/bootstrap.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index-2.html" class="logo">
      <!-- mini logo -->
	  <div class="logo-mini">
		  <span class="light-logo"><img src="app/view/allfiles/images/logo-dark.png" alt="logo"></span>
		  <span class="dark-logo"><img src="app/view/allfiles/images/logo-dark.png" alt="logo"></span>
	  </div>
      <!-- logo-->
      <div class="logo-lg">
		  <span class="light-logo"><img src="app/view/allfiles/images/logo-dark-text.png" alt="logo"></span>
	  	  <span class="dark-logo"><img src="app/view/allfiles/images/logo-dark-text.png" alt="logo"></span>
	  </div>
    </a>
    <!-- Header Navbar -->
			  ...
			  <li>
				...
				<ul class="menu sm-scrol">
				  <li><!-- start message -->
					<a href="#">
					  <div class="pull-left">
						<img src="app/view/allfiles/images/user2-160x160.jpg" class="rounded-circle" alt="User Image">
					  </div>
				  ...
				  <li>
					<a href="#">
					  <div class="pull-left">
						<img src="app/view/allfiles/images/user3-128x128.jpg" class="rounded-circle" alt="User Image">
					  </div>
					  <div class="mail-contnet">
						 <h4>
						  Nullam tempor
				  ...
				  <li>
					<a href="#">
					  <div class="pull-left">
						<img src="app/view/allfiles/images/user4-128x128.jpg" class="rounded-circle" alt="User Image">
					  </div>
					  <div class="mail-contnet">
						 <h4>
						  Proin venenatis
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu animated flipInX">
              ...
              <li class="user-body">
					...
					<a class="dropdown-item" href="wallet"><i class="ion ion-bag"></i> My Balance</a>
