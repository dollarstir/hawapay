...
<!-- Mirrored from crypto-admin-templates.multipurposethemes.com/sass/classic/pages/sample_blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 Jun 2023 04:43:02 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="https://crypto-admin-templates.multipurposethemes.com/sass/images/favicon.ico">
			  ...
			  <ul class="sidebar-menu" data-widget="tree">
				...
				<li class="treeview">
				  ...
				  <ul class="treeview-menu">
					<li><a href="../index-2.html"><i class="ti-more"></i>Dashboard 1</a></li>
					<li><a href="../index-3.html"><i class="ti-more"></i>Dashboard 2</a></li>
					<li><a href="../index-4.html"><i class="ti-more"></i>Dashboard 3</a></li>
					<li><a href="../index-5.html"><i class="ti-more"></i>Dashboard 4</a></li>
				  </ul>
				</li>
				<li class="treeview">
				  <a href="#">
		  	...
		  	<div class="row">
                ...
                <div class="box-body box">
					...
					<ul class="nav nav-tabs customtab2" role="tablist">
						<li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home7" role="tab" aria-selected="false"><span class="hidden-sm-up">Account<img src="../../images/card/ghana.svg" style="width:16px;height:16px;"> (GHS)</span> <span class="hidden-xs-down">Account<img src="../../images/card/ghana.svg" style="width:16px;height:16px;"> (GHS)</span></a> </li>
						<li class="nav-item"> <a class="nav-link " data-toggle="tab" href="#profile7" role="tab" aria-selected="true"><span class="hidden-sm-up">Account<img src="../../images/card/nigeria.svg" style="width:16px;height:16px;"> (NGN)</span> <span class="hidden-xs-down">Account<img src="../../images/card/nigeria.svg" style="width:16px;height:16px;"> (NGN)</span></a> </li>
                                    ...
                                    <div class="info mb-5 mb-md-12">
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <div
                                                ...
                                                <img src="../../images/card/wallet.png" style="">

                                            </div>
                                        </div>
                                        <div class="clearfix mb-20"></div>
                                        <h5 class="mb-5">Account Wallet (GHS)</h5>
                                        <div><h1 class="mb-2 font-monospace fw-bolder" style="color:#061f3c;">0 GHS</h1><p class="bluey-grey-text"><small class="text-uppercase">Wallet balance</small></p>
                                        </div>

                                        <div class="clearfix"></div>
                                        <button type="button"  data-toggle="modal" data-target="#modal-universal" class="btn btn-primary mb-5 mr-10">Deposit</button><button type="button" class="btn btn-secondary mb-5">Withdraw</button><button type="button"  data-toggle="modal" data-target="#modal-universal" class="btn btn-primary mb-5 ml-10">Tranfer to Naira</button>
                                    </div>
                                </div>
                            ...
                            <div class="p-15">
							    <div style="padding: 2rem 1.5rem;border-radius: 0.375rem;text-align: center;background-color: #fafbfc;border: solid 0.0625rem #edf0f2;" >
                                    <div class="info mb-5 mb-md-12">
                                        ...
                                        <div><h1 class="mb-2 font-monospace fw-bolder" style="color:#061f3c;">0 NGN</h1><p class="bluey-grey-text"><small class="text-uppercase">Wallet balance</small></p>
                                        </div>
      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
        ...
        <ul class="todo-list mt-20">
			...
			<li class="py-15 px-5">
			  ...
			  <div class="tools">
				<i class="fa fa-edit"></i>
				<i class="fa fa-trash-o"></i><div class="sc-fnykZs UOncG justify-content-center align-items-center mb-12"><div width="136" class="sc-gXmSlM hcLCzv text-center"><small class="d-block clear-blue-text text-uppercase mb-4">FROM</small><div size="84" class="sc-jSMfEi kTVfHI mx-auto mb-4" opacity="1"><svg fill="none" width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><path d="M4 11.8605C4 10.833 4.83296 10 5.86047 10H37.4884C39.5434 10 41.2093 11.6659 41.2093 13.7209V36.2791C41.2093 38.3341 39.5434 40 37.4884 40H5.86046C4.83296 40 4 39.167 4 38.1395V11.8605Z" fill="#FFB121"></path><rect x="7" y="13" width="36" height="24" fill="#5FC484"></rect><rect x="7" y="16" width="34" height="18" fill="#6DD194"></rect><path d="M4 11.8605C4 10.833 4.83296 10 5.86047 10H35.0884C37.1434 10 38.8093 11.6659 38.8093 13.7209V36.2791C38.8093 38.3341 37.1434 40 35.0884 40H5.86047C4.83296 40 4 39.167 4 38.1395V11.8605Z" fill="#FFC642"></path><path d="M29.1162 23.1105C29.1162 22.083 29.9492 21.25 30.9767 21.25H43.9999V30.625H30.9767C29.9492 30.625 29.1162 29.792 29.1162 28.7645V23.1105Z" fill="#FFB121"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M34.6979 27.8125C35.7254 27.8125 36.5583 26.973 36.5583 25.9375C36.5583 24.902 35.7254 24.0625 34.6979 24.0625C33.6704 24.0625 32.8374 24.902 32.8374 25.9375C32.8374 26.973 33.6704 27.8125 34.6979 27.8125Z" fill="#E79A1D"></path></svg></div><small class="text-uppercase bluey-grey-text mb-2">CASH-OUT WALLET</small><p class="fw-bolder font-monospace">0.00 GHS</p></div><svg width="24" fill="var(--navy)" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="mx-auto"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M5 13h11.17l-4.88 4.88c-.39.39-.39 1.03 0 1.42.39.39 1.02.39 1.41 0l6.59-6.59c.39-.39.39-1.02 0-1.41l-6.58-6.6c-.39-.39-1.02-.39-1.41 0-.39.39-.39 1.02 0 1.41L16.17 11H5c-.55 0-1 .45-1 1s.45 1 1 1z"></path></svg><div width="136" class="sc-gXmSlM hcLCzv text-center"><small class="d-block clear-blue-text text-uppercase mb-4">TO</small><div size="84" class="sc-jSMfEi kTVfHI mx-auto mb-4" opacity="1"><svg width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path d="M0 0h48v48H0z"></path><g transform="translate(4 10)"><path fill="#FFB121" d="M1.86 0h31.628a3.72 3.72 0 0 1 3.721 3.72v22.56A3.72 3.72 0 0 1 33.49 30H1.86A1.86 1.86 0 0 1 0 28.14V1.86A1.86 1.86 0 0 1 1.86 0z"></path><path fill="#5FC484" d="M3 3h36v24H3z"></path><path fill="#6DD194" d="M3 6h34v18H3z"></path><path fill="#FFC642" d="M1.86 0h29.228a3.72 3.72 0 0 1 3.721 3.72v22.56A3.72 3.72 0 0 1 31.09 30H1.86A1.86 1.86 0 0 1 0 28.14V1.86A1.86 1.86 0 0 1 1.86 0z"></path><path fill="#FFB121" d="M26.977 11.25H40v9.375H26.977a1.86 1.86 0 0 1-1.86-1.86V13.11a1.86 1.86 0 0 1 1.86-1.86z"></path><ellipse cx="30.698" cy="15.938" fill="#E79A1D" rx="1.86" ry="1.875"></ellipse></g><g fill="#E79A1D" stroke="#E79A1D" stroke-linecap="round" stroke-width="1.571"><path stroke-linejoin="round" d="M23.51 23.537l-4.37-4.371 4.37 4.371zm-8.815.073l4.444-4.444-4.444 4.444z"></path><path d="M19.029 31.246V20.318"></path></g></g></svg></div><small class="text-uppercase bluey-grey-text mb-2">PREPAID WALLET</small><p class="fw-bolder font-monospace">0.00 GHS</p></div></div>57" class="filled-in">
