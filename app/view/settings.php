						...
						<div class="tab-content">
								...
								<div class="row text-center" style="padding:30px;">
									...
									<div class="col-lg-6 mt-15">
										...
										<div class="progress" style="height: 30px;">
											<div class="progress-bar" role="progressbar" style="width: 25%;font-size: 12px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">95% remaining
											</div>
										</div>
										<br><br>
								...
								<form class="form-horizontal  editgeneral">
									<div class="form-group row padding:10px !important;">
										<div class="col-lg-4">
											...
											<div class="col-md-12">
												<input type="text" class="form-control h-50 fw-bolder" placeholder="type name" name="first_name" value="<?= $user['first_name'] ?>" disabled>
										...
										<div class="col-lg-4">
											...
											<div class="col-md-12">
												<input type="text" class="form-control h-50 fw-bolder" placeholder="type name" name="last_name" value="<?= $user['last_name'] ?>" disabled>
											</div>
										</div>
									...
									<div class="form-group row ">
										...
										<div class="col-lg-4">
											...
											<div class="col-md-12">
												<input type="number" class="form-control h-50 fw-bolder" placeholder="phone number" name="primary_number" value="<?= $user['primary_number'] ?>" disabled>
											</div>
										</div>
								...
								<form class="form-horizontal  editgeneral">
									...
									<div class="form-group row">
										<div class="col-lg-4">
											...
											<div class="col-md-12">
												<input type="text" class="form-control h-50 fw-bolder" placeholder="House number / GPS Address" value="<?= $user['gps_address']; ?>" name="gps_address">
												<input type="hidden" name="uid" value="<?= $user['uid']; ?>">
											</div>
									...
									<div style="justify-content: center; display: flex;"><button type="submit" class="btn btn-primary mb-5">Save</button></div>
							...
							<div class="tab-pane box" id="security">
								...
								<form class="form-horizontal  changepassword">
									...
									<div style="justify-content: center; display: flex;"><button type="submit" class="btn btn-primary mb-5" type="submit">Save</button></div>
								...
								<div class="box p-15">
									...
									<div class="numbersbox">
										<div class="row">
											...
											<p class="col-6">+233 <?= $user['primary_number']; ?> <svg width="14" fill="#39DA8A" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
												...
												</svg><small class="mt-15 text-success fw-bolder">verified</small></p>
