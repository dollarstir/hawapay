        ...
        <div class="user-profile">
			...
			<div class="profile-pic">
				<!-- <img src="app/view/allfiles/images/user5-128x128.jpg" alt="user">	 -->
				     <div style="background-color:#5A8DEE;border-color: #5A8DEE;border-radius:50%;color:#fff;width:50px;height:50px;padding:12px;margin-left:100px;font-weight:bolder;font-size:20px;">FE</div>
					...
					<small class="mt-15 text-primary fw-bolder">verified</small><br><br>
