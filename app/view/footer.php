          ...
          <div class="media-list media-list-hover mt-20">
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-success" href="#">
				<img src="app/view/allfiles/images/avatar/1.jpg" alt="...">
			  </a>
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-danger" href="#">
				<img src="app/view/allfiles/images/avatar/2.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-warning" href="#">
				<img src="app/view/allfiles/images/avatar/3.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
			...
			<div class="media py-10 px-0">
			  <a class="avatar avatar-lg status-primary" href="#">
				<img src="app/view/allfiles/images/avatar/4.jpg" alt="...">
			  </a>
			  <div class="media-body">
				<p class="font-size-16">
				  <a class="hover-primary" href="#"><strong>Evan</strong></a>
...
<!-- ./wrapper -->
	...
	<script src="app/view/allfiles/assets/vendor_components/screenfull/screenfull.js"></script>
	<script src="app/view/allfiles/assets/vendor_components/popper/dist/popper.min.js"></script>
	<script src="app/view/allfiles/assets/vendor_components/bootstrap/dist/js/bootstrap.js"></script>	
	<script src="app/view/allfiles/assets/vendor_components/jquery-slimscroll/jquery.slimscroll.js"></script>
	<script src="app/view/allfiles/assets/vendor_components/fastclick/lib/fastclick.js"></script>
	<script src="app/view/allfiles/assets/vendor_components/perfect-scrollbar/dist/perfect-scrollbar.js"></script>
	
	<!--Vendor -->
	<script src="app/view/allfiles/assets/vendor_components/Web-Ticker-master/jquery.webticker.min.js"></script>
	...
	<!-- Crypto Admin App -->
	<script src="app/view/allfiles/js/template.js"></script>
	<script src="app/view/allfiles/js/pages/dashboard4.js"></script>
	<script src="app/view/allfiles/js/pages/dashboard4-chart.js"></script>
