...
--
-- Host: localhost:3306
-- Generation Time: Dec 23, 2023 at 05:42 AM
...
CREATE TABLE `deposit_method` (
  ...
  `status` int(11) DEFAULT NULL COMMENT '1: active , 2: Inactve',
...
CREATE TABLE `orders` (
  ...
  `order_type` int(11) NOT NULL COMMENT '1: Purchase , 2: Sale',
  `amount_usd` double DEFAULT NULL,
  `amount_ghs` double DEFAULT NULL,
  `amount_naira` double DEFAULT NULL,
  `raw_date` varchar(100) DEFAULT NULL,
  `date_created` varchar(100) DEFAULT NULL,
  `order_status` int(11) NOT NULL COMMENT '-1 : rejected\r\n0: pending\r\n1: waiting \r\n2: confirmed \r\n3: processed'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `transaction` (
  ...
  `transaction_wallet` int(11) DEFAULT NULL COMMENT '1: Wallet 1(GH Account)\r\n2: Wallet 2( Naira Account)',
  `date_created` varchar(100) DEFAULT NULL,
